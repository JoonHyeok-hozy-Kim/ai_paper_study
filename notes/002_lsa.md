...
#### 1) The Singular Value Decomposition (SVD) Model 

<img src="../images/002_lsa/03_02_02.png" width="60%" style="padding-left:10%"></img>
  ...
  * It allows a simple strategy for optimal approximate fit using smaller matrices.
    ...
    * Derivation)
      1. The singular values in $S_0$ are ordered by size.
         * Recall the setting and the convention!
...
<img src="../images/002_lsa/03_02_03.png" width="60%" style="padding-left:20%"></img>
