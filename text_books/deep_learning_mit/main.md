...
|6.5|[Back-Propagation and Other Differentiation Algorithms](ch06/05/note.md)|- Forward Propagation / Back-Propagation <br> - Computational Graph : Node, Operation <br> - Chain Rule : Scalar, Vector, Tensor <br>- Symbol-to-Number Differentiation / Symbol-to-Symbol Differentiation <br> - General Back-Propagation, Time Complexity of the Back-Propagation Algorithm, Dynamic Programming <br> - [Back-Propagation Example with a Diagram](ch06/05/note.md#657-example-back-propagation-for-mlp-training)|
|6.6|[](ch06/06/note.md)|- |
