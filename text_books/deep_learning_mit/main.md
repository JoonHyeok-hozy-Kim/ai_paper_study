...
|8.4|[Parameter Initialization Strategies](ch08/04/note.md)|- Weight / Bias Initialization Heuristics (TBD)|
|8.5|[Algorithms with Adaptive Learning Rates](ch08/05/note.md)|- AdaGrad (TBD), RMSProp (TBD), Adam (TBD)|
