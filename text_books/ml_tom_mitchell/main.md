...
|7.3|[Sample Complexity for Finite Hypothesis Spaces](./ch07/03/note.md)|Sample complexity, Consistent Learner, Exhausted Version Space, General Bound on the Number of Training Examples, Agnostic Learner, Hoeffding Bounds|
