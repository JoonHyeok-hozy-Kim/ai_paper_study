...
|10.6|[Induction as Inverted Deduction](./ch10/06/note.md)|- $`(\forall \langle x_i, f(x_i) \rangle \in D) (B \wedge h \wedge x_i) \vdash f(x_i)`$ <br>- Constructive Induction <br>- Inverse Entailment Operator|
