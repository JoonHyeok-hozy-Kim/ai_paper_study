...
|7.5|[The Mistake Bound Model of Learning](./ch07/05/note.md)|The Mistake Bound Model : Find-S, Halving Algorithm<br>Optimal Mistake Bound<br> Weighted-Majority Algorithm : Mistake Bound <span style="color: #03F3B3;">(Verification Required!)</span><br>|
