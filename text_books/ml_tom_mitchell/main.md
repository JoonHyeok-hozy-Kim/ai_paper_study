...
|7.4|[Sample Complexity for Infinite Hypothesis Spaces](./ch07/04/note.md)|Shattering a Set of Instances, Vapnik-Chervonenkis Dimension (VC Dimension), Upper/Lower Bound on Sample Complexity using $VC(H)$|
